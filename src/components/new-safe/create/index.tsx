...
const CreateSafe = () => {
  ...
  const CreateSafeSteps: TxStepperProps<NewSafeFormData>['steps'] = [
    {
      title: 'Select a name and ID for your Prosperity Pass',
      subtitle: '',
    ...
    {
      title: 'Customize your Prosperity Pass Avatar',
      subtitle: 'This avatar will be the face of your Prosperity Pass',
      render: (data, onSubmit, onBack, setStep) => (
    ...
    },
    {
      title: 'Review',
      subtitle:
        "You're about to create a new Prosperity Pass and will have to confirm the transaction with your connected wallet.",
      render: (data, onSubmit, onBack, setStep) => (
