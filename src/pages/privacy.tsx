...
const SafePrivacyPolicy = () => (
  <SmoothScroll>
    ...
    <ol>
      ...
      <li>
        &ldquo;Prosperity Pass&rdquo; refers to a web-based graphical user interface for Safe Accounts as well as a
    ...
    <h4>4.1. When visiting our website and using Prosperity Pass</h4>
    <p>
      When visiting our website or using Prosperity Pass, we may collect and process personal data. The data will be
    ...
    <ol start={4}>
      <li>
        ...
        the Prosperity Pass, we process your
        <ol>
    ...
    <p>
      In addition, we may take a recording of you while testing Prosperity Pass for internal and external use. The basis
    ...
    <p>
      Prosperity Pass mobile apps are distributed via{' '}
    ...
    <p>
      We enable the user to unlock the Prosperity Pass mobile app via biometrics information (touch ID or face ID). This
    ...
    <p>
      ...
      different decentralized applications and our app and to enhance your experience with Prosperity Pass. For enhanced
...
const PrivacyPolicy: NextPage = () => {
  return (
    <>
      <Head>
        <title>Prosperity Pass – Privacy policy</title>
      </Head>
