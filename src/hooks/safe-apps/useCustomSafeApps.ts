...
const fakeSafeApps: SafeAppData[] = [
  {
    ...
    description:
      'Claim free tickets in the weekly Prosperity Account Raffle based on your Prosperity Account level for a chance to win rewards.',
    accessControl: {
    ...
    developerWebsite: '',
    chainIds: ['10'],
    iconUrl: 'https://account.celopg.eco/images/apps/raffle.jpg',
  },
  {
    id: 48,
  ...
  },
  {
    ...
    iconUrl: 'https://account.celopg.eco/images/apps/velodrome.jpg',
    description:
